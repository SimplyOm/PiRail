...
stops=[14,26,41,60,79,92]
stop_time=['10','12','15','5','15']
'''
1 Dehradun
14 Meerut City
26 Mathura
...
counter,st_index,end_index=[1,26,79]
last,board,depart,end,information,=['','','','','']
...
def updatesim():
    global counter,st_index,end_index,last,board,source,depart,end,information
    information=''
    ...
    if counter==1:
        ...
        last='The train was last seen at '+dic[counter-1]['station_']['name']+'('+dic[counter-1]['station_']['code']+') and is '+dic[counter-1]['status']+'. It is at a distance '+str(dic[st_index]['distance']-dic[counter-1]['distance'])+'km from your boarding point.'
    elif counter<=end_index:
        last='The train was last seen at '+dic[counter-1]['station_']['name']+'('+dic[counter-1]['station_']['code']+') and is '+dic[counter-1]['status']+'. You have covered a distance '+str(dic[counter-1]['distance']-dic[st_index]['distance'])+'km from your boarding point.'        
    else:
        last='The train was last seen at '+dic[counter-1]['station_']['name']+'('+dic[counter-1]['station_']['code']+') and is '+dic[counter-1]['status']+'.'
    if counter==1:
    ...
    counter+=1
    result=information+'<br><br><br>'+last+'<br>'+board+'<br>'+depart
    return result
